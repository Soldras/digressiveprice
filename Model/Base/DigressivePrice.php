...
abstract class DigressivePrice implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\DigressivePrice\\Model\\Map\\DigressivePriceTableMap';
    ...
    /**
     * The value for the quantity_from field.
     * @var        int
     */
    protected $quantity_from;

    /**
     * The value for the quantity_to field.
     * @var        int
     */
    ...
    /**
     * Initializes internal state of DigressivePrice\Model\Base\DigressivePrice object.
     */
    ...
    /**
     * Compares this with another <code>DigressivePrice</code> instance.  If
     * <code>obj</code> is an instance of <code>DigressivePrice</code>, delegates to
     * <code>equals(DigressivePrice)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return DigressivePrice The current object, for fluid interface
     */
    ...
    /**
     * Get the [quantity_from] column value.
     *
     * @return   int
     */
    ...
    /**
     * Get the [quantity_to] column value.
     *
     * @return   int
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DigressivePriceTableMap::ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[DigressivePriceTableMap::PRODUCT_ID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[DigressivePriceTableMap::PRICE] = true;
        }
    ...
    public function setPromoPrice($v)
    {
        ...
        if ($this->promo_price !== $v) {
            $this->promo_price = $v;
            $this->modifiedColumns[DigressivePriceTableMap::PROMO_PRICE] = true;
        }
    ...
    /**
     * Set the value of [quantity_from] column.
     *
     * @param      int $v new value
     * @return   \DigressivePrice\Model\DigressivePrice The current object (for fluent API support)
     */
    public function setQuantityFrom($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->quantity_from !== $v) {
            $this->quantity_from = $v;
            $this->modifiedColumns[DigressivePriceTableMap::QUANTITY_FROM] = true;
        }
    ...
    /**
     * Set the value of [quantity_to] column.
     *
     * @param      int $v new value
     * @return   \DigressivePrice\Model\DigressivePrice The current object (for fluent API support)
     */
    public function setQuantityTo($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->quantity_to !== $v) {
            $this->quantity_to = $v;
            $this->modifiedColumns[DigressivePriceTableMap::QUANTITY_TO] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDigressivePriceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildDigressivePriceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DigressivePriceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DigressivePriceTableMap::QUANTITY_FROM)) {
            $modifiedColumns[':p' . $index++]  = 'QUANTITY_FROM';
        }
        if ($this->isColumnModified(DigressivePriceTableMap::QUANTITY_TO)) {
            $modifiedColumns[':p' . $index++]  = 'QUANTITY_TO';
        }

        $sql = sprintf(
            'INSERT INTO digressive_price (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'PROMO_PRICE':
                        ...
                        break;
                    case 'QUANTITY_FROM':
                        $stmt->bindValue($identifier, $this->quantity_from, PDO::PARAM_INT);
                        break;
                    case 'QUANTITY_TO':
                        $stmt->bindValue($identifier, $this->quantity_to, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = DigressivePriceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DigressivePrice\Model\DigressivePrice (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \DigressivePrice\Model\DigressivePrice Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProduct(ConnectionInterface $con = null)
    {
        if ($this->aProduct === null && ($this->product_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProduct->addDigressivePrices($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DigressivePriceTableMap::DEFAULT_STRING_FORMAT);
    }
